...
with open(file_to_save, "w") as txt_file:
    ...
    for county_name in county_votes:
        ...
        if (county_vote_count > largest_turnout_vote_count) and (county_vote_percentage > largest_county_turnout_percentage):
            largest_turnout_vote_count = county_vote_count
    ...
    largest_turnout_county_summary = (
        ...
        f"County Vote Count: {largest_turnout_vote_count:,}\n"
        f"County Vote Percentage: {largest_county_turnout_percentage:.1f}%\n"
        f"-------------------------\n")
